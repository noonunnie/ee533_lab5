...
def DEVICE_PROJ_DESC ():
    return "Lab5 - Pipelined Processor with NetFPGA Router"
...
def PIPELINE_REG_DMEM_DATA_LO_REG (): 
    return 0x2000200

def PIPELINE_REG_DMEM_DATA_HI_REG (): 
    return 0x2000204

def PIPELINE_REG_DMEM_ADDR_REG ():    
    return 0x2000208

def PIPELINE_REG_IMEM_ADDR_REG ():    
    return 0x200020c

def PIPELINE_REG_IMEM_OUT_REG ():     
    return 0x2000210

def PIPELINE_PIPELINE_C_REG ():       
    return 0x2000214

def PIPELINE_PROC_RESET_REG ():       
    return 0x2000218
...
__main__.nf_regmap.update({
    ...
    0x2000100 : "ROUTER_OP_LUT_ARP_NUM_MISSES_REG",
    0x2000104 : "ROUTER_OP_LUT_LPM_NUM_MISSES_REG",
    0x2000108 : "ROUTER_OP_LUT_NUM_CPU_PKTS_SENT_REG",
    0x200010c : "ROUTER_OP_LUT_NUM_BAD_OPTS_VER_REG",
    0x2000110 : "ROUTER_OP_LUT_NUM_BAD_CHKSUMS_REG",
    0x2000114 : "ROUTER_OP_LUT_NUM_BAD_TTLS_REG",
    0x2000118 : "ROUTER_OP_LUT_NUM_NON_IP_RCVD_REG",
    0x200011c : "ROUTER_OP_LUT_NUM_PKTS_FORWARDED_REG",
    0x2000120 : "ROUTER_OP_LUT_NUM_WRONG_DEST_REG",
    0x2000124 : "ROUTER_OP_LUT_NUM_FILTERED_PKTS_REG",
    0x2000128 : "ROUTER_OP_LUT_MAC_0_HI_REG",
    0x200012c : "ROUTER_OP_LUT_MAC_0_LO_REG",
    0x2000130 : "ROUTER_OP_LUT_MAC_1_HI_REG",
    0x2000134 : "ROUTER_OP_LUT_MAC_1_LO_REG",
    0x2000138 : "ROUTER_OP_LUT_MAC_2_HI_REG",
    0x200013c : "ROUTER_OP_LUT_MAC_2_LO_REG",
    0x2000140 : "ROUTER_OP_LUT_MAC_3_HI_REG",
    0x2000144 : "ROUTER_OP_LUT_MAC_3_LO_REG",
    0x2000148 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG",
    0x200014c : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG",
    0x2000150 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG",
    0x2000154 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG",
    0x2000158 : "ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG",
    0x200015c : "ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG",
    0x2000160 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG",
    0x2000164 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG",
    0x2000168 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG",
    0x200016c : "ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG",
    0x2000170 : "ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG",
    0x2000174 : "ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG",
    0x2000178 : "ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG",
    0x200017c : "ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG",

    0x2000200 : "PIPELINE_REG_DMEM_DATA_LO_REG",
    0x2000204 : "PIPELINE_REG_DMEM_DATA_HI_REG",
    0x2000208 : "PIPELINE_REG_DMEM_ADDR_REG",
    0x200020c : "PIPELINE_REG_IMEM_ADDR_REG",
    0x2000210 : "PIPELINE_REG_IMEM_OUT_REG",
    0x2000214 : "PIPELINE_PIPELINE_C_REG",
    0x2000218 : "PIPELINE_PROC_RESET_REG",
