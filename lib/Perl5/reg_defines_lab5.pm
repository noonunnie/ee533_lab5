...
#
# Project: Lab5 (lab5)
# Description: Lab5 - Pipelined Processor with NetFPGA Router
#
#############################################################
...
@EXPORT = qw(
                ...
                PIPELINE_REG_DMEM_DATA_LO_REG
                PIPELINE_REG_DMEM_DATA_HI_REG
                PIPELINE_REG_DMEM_ADDR_REG
                PIPELINE_REG_IMEM_ADDR_REG
                PIPELINE_REG_IMEM_OUT_REG
                PIPELINE_PIPELINE_C_REG
                PIPELINE_PROC_RESET_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_NAME () { "Lab5"; }
sub DEVICE_PROJ_DESC () { "Lab5 - Pipelined Processor with NetFPGA Router"; }
...
sub ROUTER_OP_LUT_BASE_ADDR ()   { 0x2000100; }
sub PIPELINE_BASE_ADDR ()        { 0x2000200; }
...
# File: lib/verilog/core/output_port_lookup/cam_router/xml/cam_router.xml
sub ROUTER_OP_LUT_ARP_NUM_MISSES_REG ()                  { 0x2000100;}
sub ROUTER_OP_LUT_LPM_NUM_MISSES_REG ()                  { 0x2000104;}
sub ROUTER_OP_LUT_NUM_CPU_PKTS_SENT_REG ()               { 0x2000108;}
sub ROUTER_OP_LUT_NUM_BAD_OPTS_VER_REG ()                { 0x200010c;}
sub ROUTER_OP_LUT_NUM_BAD_CHKSUMS_REG ()                 { 0x2000110;}
sub ROUTER_OP_LUT_NUM_BAD_TTLS_REG ()                    { 0x2000114;}
sub ROUTER_OP_LUT_NUM_NON_IP_RCVD_REG ()                 { 0x2000118;}
sub ROUTER_OP_LUT_NUM_PKTS_FORWARDED_REG ()              { 0x200011c;}
sub ROUTER_OP_LUT_NUM_WRONG_DEST_REG ()                  { 0x2000120;}
sub ROUTER_OP_LUT_NUM_FILTERED_PKTS_REG ()               { 0x2000124;}
sub ROUTER_OP_LUT_MAC_0_HI_REG ()                        { 0x2000128;}
sub ROUTER_OP_LUT_MAC_0_LO_REG ()                        { 0x200012c;}
sub ROUTER_OP_LUT_MAC_1_HI_REG ()                        { 0x2000130;}
sub ROUTER_OP_LUT_MAC_1_LO_REG ()                        { 0x2000134;}
sub ROUTER_OP_LUT_MAC_2_HI_REG ()                        { 0x2000138;}
sub ROUTER_OP_LUT_MAC_2_LO_REG ()                        { 0x200013c;}
sub ROUTER_OP_LUT_MAC_3_HI_REG ()                        { 0x2000140;}
sub ROUTER_OP_LUT_MAC_3_LO_REG ()                        { 0x2000144;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG ()            { 0x2000148;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG ()          { 0x200014c;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG ()   { 0x2000150;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG ()   { 0x2000154;}
sub ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG ()             { 0x2000158;}
sub ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG ()             { 0x200015c;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG ()          { 0x2000160;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG ()          { 0x2000164;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG ()     { 0x2000168;}
sub ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG ()               { 0x200016c;}
sub ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG ()               { 0x2000170;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG ()    { 0x2000174;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG ()     { 0x2000178;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG ()     { 0x200017c;}

# Name: pipeline (PIPELINE)
# Description: Registers for Pipeline
# File: projects/lab5/include/pipeline.xml
sub PIPELINE_REG_DMEM_DATA_LO_REG ()   { 0x2000200;}
sub PIPELINE_REG_DMEM_DATA_HI_REG ()   { 0x2000204;}
sub PIPELINE_REG_DMEM_ADDR_REG ()      { 0x2000208;}
sub PIPELINE_REG_IMEM_ADDR_REG ()      { 0x200020c;}
sub PIPELINE_REG_IMEM_OUT_REG ()       { 0x2000210;}
sub PIPELINE_PIPELINE_C_REG ()         { 0x2000214;}
sub PIPELINE_PROC_RESET_REG ()         { 0x2000218;}
