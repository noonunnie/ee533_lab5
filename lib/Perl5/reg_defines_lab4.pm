...
sub ROUTER_OP_LUT_BASE_ADDR ()   { 0x2001100; }
...
# File: lib/verilog/core/output_port_lookup/cam_router/xml/cam_router.xml
sub ROUTER_OP_LUT_ARP_NUM_MISSES_REG ()                  { 0x2001100;}
sub ROUTER_OP_LUT_LPM_NUM_MISSES_REG ()                  { 0x2001104;}
sub ROUTER_OP_LUT_NUM_CPU_PKTS_SENT_REG ()               { 0x2001108;}
sub ROUTER_OP_LUT_NUM_BAD_OPTS_VER_REG ()                { 0x200110c;}
sub ROUTER_OP_LUT_NUM_BAD_CHKSUMS_REG ()                 { 0x2001110;}
sub ROUTER_OP_LUT_NUM_BAD_TTLS_REG ()                    { 0x2001114;}
sub ROUTER_OP_LUT_NUM_NON_IP_RCVD_REG ()                 { 0x2001118;}
sub ROUTER_OP_LUT_NUM_PKTS_FORWARDED_REG ()              { 0x200111c;}
sub ROUTER_OP_LUT_NUM_WRONG_DEST_REG ()                  { 0x2001120;}
sub ROUTER_OP_LUT_NUM_FILTERED_PKTS_REG ()               { 0x2001124;}
sub ROUTER_OP_LUT_MAC_0_HI_REG ()                        { 0x2001128;}
sub ROUTER_OP_LUT_MAC_0_LO_REG ()                        { 0x200112c;}
sub ROUTER_OP_LUT_MAC_1_HI_REG ()                        { 0x2001130;}
sub ROUTER_OP_LUT_MAC_1_LO_REG ()                        { 0x2001134;}
sub ROUTER_OP_LUT_MAC_2_HI_REG ()                        { 0x2001138;}
sub ROUTER_OP_LUT_MAC_2_LO_REG ()                        { 0x200113c;}
sub ROUTER_OP_LUT_MAC_3_HI_REG ()                        { 0x2001140;}
sub ROUTER_OP_LUT_MAC_3_LO_REG ()                        { 0x2001144;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG ()            { 0x2001148;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG ()          { 0x200114c;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG ()   { 0x2001150;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG ()   { 0x2001154;}
sub ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG ()             { 0x2001158;}
sub ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG ()             { 0x200115c;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG ()          { 0x2001160;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG ()          { 0x2001164;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG ()     { 0x2001168;}
sub ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG ()               { 0x200116c;}
sub ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG ()               { 0x2001170;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG ()    { 0x2001174;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG ()     { 0x2001178;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG ()     { 0x200117c;}
