...
//
//              Lab5 - Pipelined Processor with NetFPGA Router
//
///////////////////////////////////////////////////////////////////////////////
...
`define PIPELINE_BLOCK_ADDR_WIDTH       19
`define PIPELINE_REG_ADDR_WIDTH         4
...
`define PIPELINE_BLOCK_ADDR       19'h00008
...
`define PIPELINE_REG_DMEM_DATA_LO  4'h0
`define PIPELINE_REG_DMEM_DATA_HI  4'h1
`define PIPELINE_REG_DMEM_ADDR     4'h2
`define PIPELINE_REG_IMEM_ADDR     4'h3
`define PIPELINE_REG_IMEM_OUT      4'h4
`define PIPELINE_PIPELINE_C        4'h5
`define PIPELINE_PROC_RESET        4'h6
